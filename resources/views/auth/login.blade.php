...
<head>
    ...
    <title>Login - Power Monitoring</title>
        ...
        <div class="card card-login">
            <div class="card-header text-center pb-2">
                <div class="logo-container" style="margin-bottom: 15px;">
                    <img src="{{ asset('assets/img/login-logo.png') }}" alt="Login Logo" style="width: 150px;">
                </div>
                <h4 class="card-title font-weight-bold mb-1" style="color: #333;">Login User</h4>
                <p class="text-muted small font-weight-bold text-uppercase">Power Monitoring</p>
            </div>
            ...
            <div class="card-body pt-2">
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <button type="submit" class="btn btn-primary btn-round btn-lg btn-block mb-3 shadow">LOGIN</button>
                    
                    <div class="text-center mt-3">
                        <span class="text-muted small">Don't have an account? <a href="{{ route('register') }}" class="font-weight-bold text-primary">Register</a></span>
                    </div>
                </form>
            </div>
        </div>
